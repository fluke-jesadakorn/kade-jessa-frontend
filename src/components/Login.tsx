...
const Login = ({ ENDPOINT }) => {
  ...
  return (
    <div>
      {fail && (
        <div className="alert alert-error shadow-lg fixed">
          <div>
            <svg
      ...
      <form
        ...
        className="flex flex-col align-middle h-screen justify-center px-64"
      >
        ...
        <div className="form-control py-4 w-full">
          <button className="btn btn-primary p-4" type="submit">
            Login
          </button>
        </div>
      </form>
